...
export default function HomeDashboard() {
  ...
  const handleCreateAssignment = (e) => {
    ...
    setSuccessMsg('Assignment dispatched to students through notifications!');
  ...
  const handleCreateCAT = (e) => {
    ...
    setSuccessMsg('Continuous Assessment Test added to notice schedules!');
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-1">
              ...
              <p className="text-sm text-blue-50 font-medium">
                Welcome back to your Campus Companion ecosystem.
              </p>
            </div>
